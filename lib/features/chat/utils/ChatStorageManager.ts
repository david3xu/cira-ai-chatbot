...
//  * - executeTransaction: Wraps operations in a loading state
//  * - executeWithTransaction: Executes chat-specific transactions
//  * - updateChat: Persists chat updates to storage
//  * - updateMessage: Stores message updates
//  * - deleteChat: Removes chat data
//  * - getChat: Retrieves chat data
//  * 
//  * Features:
